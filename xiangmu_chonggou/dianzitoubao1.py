...
driver.find_element_by_xpath('//*[@id="toubao1"]/a/div/a[1]/a/a/div/div').click() # 点击投保单预览
time.sleep(10)
#点击投保单预览
#点击自动核保校验
driver.find_element_by_xpath('//*[@id="toubao1"]/a/div/a[3]/div/div').click()
#点击确定
time.sleep(10)
driver.find_element_by_xpath('//*[@id="global-popups"]/div/div/div[3]/button[2]').click()
#点击投保确认
time.sleep(10)
driver.find_element_by_xpath('//*[@id="toubao1"]/a/div/a[7]/a/div/div').click()
#点击确定
time.sleep(10)
driver.find_element_by_xpath('//*[@id="global-popups"]/div/div/div[3]/button[2]').click()
#点击缴费
time.sleep(10)
driver.find_element_by_xpath('//*[@id="toubao1"]/a/div/a[9]/a/div/div').click()
#点击非在线支付
time.sleep(10)
driver.find_element_by_xpath('//*[@id="saveOfflinePayInfoPage"]').click()
#点击确定
#点击本人
time.sleep(10)
driver.find_element_by_xpath('//*[@id="offlinePay_modal"]/div/div/div[3]/div[4]/div[2]/label/span[1]/i').click()
#点击银行转账
time.sleep(10)
driver.find_element_by_xpath('//*[@id="saveOfflinePayInfo"]').click()
#点击确定
time.sleep(10)
driver.find_element_by_xpath('//*[@id="global-popups"]/div/div/div[3]/button[2]').click()
#退出
